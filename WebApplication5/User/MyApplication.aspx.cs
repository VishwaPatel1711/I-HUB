    ...
    public partial class MyApplication : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                string q = "select * from InternshipApplicationtbl where Uid ='" + Session["uid"].ToString() + "'";
        ...
        protected void Imgbtn1_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string q = "delete from InternshipApplicationtbl where IAid = '" + imgbtn.CommandArgument.ToString() + "'";
            if (con.State == ConnectionState.Closed)
                con.Open();
            cmd = new SqlCommand(q, con);
